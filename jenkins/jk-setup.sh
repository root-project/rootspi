...
then
  ...
  export ExtraCMakeOptions="-Dchirp=OFF -Dhdfs=OFF -Dbonjour=OFF -Dfail-on-missing=ON -DTCMALLOC_DIR=/afs/cern.ch/sw/lcg/app/releases/ROOT-externals/${EXTERNALS}/${ARCH}-${LABEL}-${COMPILER}-opt/tcmalloc  ${ExtraCMakeOptions}"
