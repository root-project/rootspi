...
set(CTEST_SUBMIT_RETRY_DELAY 300)

#---Git Stuff--------------------------------------------------------------
find_program(CTEST_GIT_COMMAND NAMES git)

if(NOT EXISTS ${CTEST_SOURCE_DIRECTORY})
  set(CTEST_CHECKOUT_COMMAND "${CTEST_GIT_COMMAND} clone https://github.com/root-project/root.git --branch ${CTEST_VERSION} ${CTEST_SOURCE_DIRECTORY}")
else()
