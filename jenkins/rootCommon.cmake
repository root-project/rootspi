...
function(cleanup_pr_area target_branch local_branch_name cleanup_working_dir)
  ...
  string(REPLACE "\n" ";" GITREFS ${GITREFS}) # convert multi-line git output into string.
  ...
  execute_process_and_log(COMMAND ${CTEST_GIT_COMMAND} fetch -p origin ${target_branch} WORKING_DIRECTORY ${cleanup_working_dir}
