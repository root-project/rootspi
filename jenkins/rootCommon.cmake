...
if("$ENV{ghprbPullId}" STREQUAL "")
  ...
  set(AUTHOR_REPO_GIT_URL_LOGIN "https://fix:win@github.com/$ENV{ghprbGhRepository}")
  if($ENV{ghprbGhRepository} STREQUAL "root-project/roottest")
    ...
    set(OTHER_REPO_FOR_BRANCH_SYNC_GIT_URL_LOGIN "https://fix:win@github.com/$ENV{ghprbPullAuthorLogin}/root.git")
    ...
    set(OTHER_REPO_FOR_BRANCH_SYNC_GIT_URL_LOGIN "https://fix:win@github.com/$ENV{ghprbPullAuthorLogin}/roottest.git")
