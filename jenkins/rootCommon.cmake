...
if(NOT "$ENV{GIT_COMMIT}" STREQUAL "")
  set(CTEST_CHECKOUT_COMMAND "${CTEST_GIT_COMMAND} --git_dir=${CTEST_SOURCE_DIRECTORY} checkout -f ${GIT_PREVIOUS_COMMIT}")
  set(CTEST_GIT_UPDATE_CUSTOM  "${CTEST_GIT_COMMAND} checkout -f ${GIT_COMMIT}")
endif()
