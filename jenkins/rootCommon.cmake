...
elseif(CTEST_MODE STREQUAL package)
  get_filename_component(CTEST_SOURCE_DIRECTORY root_v${CTEST_VERSION}/root-${CTEST_VERSION} ABSOLUTE)
  get_filename_component(CTEST_BINARY_DIRECTORY build/root_v${CTEST_VERSION}-cmake ABSOLUTE)
