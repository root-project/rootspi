...
elseif(CTEST_MODE STREQUAL package)
  get_filename_component(CTEST_SOURCE_DIRECTORY ${CTEST_SOURCE_PREFIX}/root_${PACKAGE_VERSION}/root-${PACKAGE_VERSION})
  get_filename_component(CTEST_BINARY_DIRECTORY ${CTEST_BUILD_PREFIX}/root_${PACKAGE_VERSION}-cmake)
  get_filename_component(CTEST_INSTALL_DIRECTORY ${CTEST_BUILD_PREFIX}/install/ROOT/${PACKAGE_VERSION}/${PACKAGE_VERSION})
else()
