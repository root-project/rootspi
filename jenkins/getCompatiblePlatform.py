...
elif (compiler == 'clang501') : new_compiler = 'gcc62'
elif (compiler == 'clang600') : new_compiler = 'gcc62binutils'
elif (compiler == 'clang501binutils') : new_compiler = 'gcc62binutils'
elif (compiler == 'clang600binutils') : new_compiler = 'gcc62binutils'
