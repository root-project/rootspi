...
function(CONFIGURE_ROOT_OPTIONS)
  ...
  if (ROOT_VERSION VERSION_GREATER_EQUAL 6.17)
    message("AXEL DEBUG 1a: ${ROOT_VERSION} VERSION_GREATER_EQUAL 6.17)")
    message("AXEL DEBUG 2a: SPECLIST ${SPECLIST}")
    if("cxx17" IN_LIST SPECLIST)
      message("AXEL DEBUG 3a7: ${specflags}")
      set(specflags ${specflags} -DCMAKE_CXX_STANDARD=17)
    elseif("cxx14" IN_LIST SPECLIST)
      message("AXEL DEBUG 3a4: ${specflags}")
      set(specflags ${specflags} -DCMAKE_CXX_STANDARD=14)
    else()
      message("AXEL DEBUG 3a1: ${specflags}")
      set(specflags ${specflags} -DCMAKE_CXX_STANDARD=11)
    endif()
    message("AXEL DEBUG 4a: ${specflags}")
  else()
    message("AXEL DEBUG 1b: NOT ${ROOT_VERSION} VERSION_GREATER_EQUAL 6.17)")
    message("AXEL DEBUG 2b: SPECLIST ${SPECLIST}")
    if("cxx17" IN_LIST SPECLIST)
      message("AXEL DEBUG 3b7: ${specflags}")
      set(specflags ${specflags} -Dcxx17=ON)
    elseif("cxx14" IN_LIST SPECLIST)
      message("AXEL DEBUG 3b4: ${specflags}")
      set(specflags ${specflags} -Dcxx14=ON)
    else()
      message("AXEL DEBUG 3b1: ${specflags}")
      set(specflags ${specflags} -Dcxx11=ON)
    endif()
    message("AXEL DEBUG 4b: ${specflags}")
  endif()
