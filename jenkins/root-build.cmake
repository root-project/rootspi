...
function(GET_ALL_SUPPORTED_MODULES_LINUX)
  ...
  # Ubu18 has apt sources from Kitware, getting latest CMake.
  ...
  if(NOT "${LABEL}" MATCHES "centos|ubuntu|-i386"
     OR "${LABEL}" MATCHES "ubuntu16|ubuntu18|ubuntu20")
    list(APPEND all_supported
      pythia8
    )
  endif()
...
function(CONFIGURE_ROOT_OPTIONS)
  ...
  if(NOT CTEST_MODE STREQUAL package)
    if (ROOT_VERSION VERSION_GREATER_EQUAL 6.17)
      ...
      elseif (ROOT_VERSION VERSION_GREATER_EQUAL 6.29)
        set(specflags ${specflags} -DCMAKE_CXX_STANDARD=17)
      elseif (ROOT_VERSION VERSION_GREATER_EQUAL 6.25)
        set(specflags ${specflags} -DCMAKE_CXX_STANDARD=14)
      else()
...
elseif(CTEST_MODE STREQUAL pullrequests)
  ...
  string(REGEX REPLACE "(https?://)" "\\1INVALID:INVALID@" OTHER_REPO_FOR_BRANCH_SYNC_GIT_URL_INVALID_CREDENTIALS "${OTHER_REPO_FOR_BRANCH_SYNC_GIT_URL}")
